...
public class HomePageController {
    ...
    @FXML
    public void naviguerVersEvent() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/GestionEvenement/AfficherFront.fxml"));
            parentNode.getScene().setRoot(root);
        } catch (IOException ex) {
            System.err.println(ex.getMessage());
        }
    ...
    @FXML
    public void naviguerVersMateriel(MouseEvent event) {
        try {
    ...
    @FXML
    public void naviguerVersCours(MouseEvent event){
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/gestionCour/GestionCour.fxml"));
            parentNode.getScene().setRoot(root);
        } catch (IOException ex) {
            System.err.println(ex.getMessage());
        }
    ...
    @FXML
    void routeToContactForm(ActionEvent event) {
        try{
            Parent root= FXMLLoader.load(getClass().getResource("/GestionUtilisateur/ContactForm.fxml"));
            parentNode.getScene().setRoot(root);
        }catch (IOException ex){
            System.err.println(ex.getMessage());
        }
    ...
    @FXML
    public void naviguerVersCode() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/gestionMateriel/CodePage.fxml"));
            parentNode.getScene().setRoot(root);
        } catch (IOException ex) {
            System.err.println(ex.getMessage());
        }
